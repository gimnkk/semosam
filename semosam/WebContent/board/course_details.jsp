		...
		<div class="row">
			<div class="col-xl-6">
				<div class="course_text">
					...
					<div class="prise">
						<span class="active">수업 카테고리</span>
					</div>
					<div class="rating">
		...
		<div class="row">
			...
			<div class="col-xl-7 col-lg-7">
				<div class="single_courses">
					<h3>수업명</h3>
					<p>수업 소개 및 내용 들어갈 곳</p>
					<h3 class="second_title">수업 정보</h3>
				</div>
							...
							<div class="card-header" id="headingTwo">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo"
										...
										<i class="flaticon-question"></i> 수업 일정 안내
									</button>
								</h5>
							</div>
							<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="card-body">수업은 월요일-금요일 오전 9시부터 오후 6시까지 진행됩니다.</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" id="headingOne">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne"
										...
										<i class="flaticon-question"></i>수업 장소 안내</span>
									</button>
								</h5>
							</div>
							<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion"
								style="">
								<div class="card-body">서울 강남구 테헤란로에 있는 한독약품 빌딩 8층 쌍용교육센터로 오세요.</div>
							</div>
						</div>
						<div class="card">
							...
							<div id="collapseThree" class="collapse" aria-labelledby="headingThree"
								...
								<div class="card-body">코로나 여파로 인해 수업 인원 최소한하여 3명 이상 5명이하로 진행합니다.</div>
							</div>
						</div>
						<div class="card">
							<div class="card-header" id="heading_4">
								<h5 class="mb-0">
									<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse_4"
										...
										<i class="flaticon-question"></i> 환불 안내
									</button>
								</h5>
							</div>
							<div id="collapse_4" class="collapse" aria-labelledby="heading_4" data-parent="#accordion">
								<div class="card-body">수업 개시 일주일 전까지는 수업 비용 100% 환불 가능합니다.
								 이후에는 수업 준비로 인해 발생하는 비용이 있기 때문에 환불 불가한 점 양해 부탁드립니다.</div>
							</div>
						</div>
						<div class="card">
							...
							<div id="collapse_5" class="collapse" aria-labelledby="heading_5" data-parent="#accordion">
								<div class="card-body">채팅 기능을 통해 문의 바랍니다.</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-xl-5 col-lg-5">
				<div class="courses_sidebar">
					...
					<div class="author_info" style="margin-top: 100px;">
						...
						<p class="text_info">쌤 소개 어쩌고 저쩌고 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 무궁화 삼천리 화려강산 대한민국 대한으로 길이 보전하세</p>
						<ul>
